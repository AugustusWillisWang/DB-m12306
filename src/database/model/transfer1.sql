...
CC_depart_city='北京' and CC_arrive_city ='抚顺' 
...
where TT_tid=CC_tid and ISC_cname='抚顺'  and TT_sid=ISC_sid and PT_tid_de=TT_tid and 
CC_depart_city='北京'and CC_arrive_city ='抚顺' and TT_price_yz!=0;
