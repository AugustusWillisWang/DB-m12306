...
FROM price_time_de,price_time_ar,Empty_Seat
WHERE PT_tid_ar=PT_tid_de and ES_date='2018-11-17' and ES_tid=PT_tid_ar and ES_current_sid=PT_depart_sid;
...
select DISTINCT PT_tid ,PT_price_yz ,PT_time ,TT_depart_time ,PT_seat_yz,PT_depart_sid_f,
PT_arrive_sid_f 
from price_time,Train_Table
where TT_sid= PT_depart_sid_f and PT_tid=TT_tid and PT_seat_yz>0
ORDER by PT_price_yz,PT_time,TT_depart_time;
...
PT_price_yz,PT_seat_yz
--,CC_day
from Train_Table as Train_Table1,ID_Station_City as ID_Station_City1, ID_Station_City as ID_Station_City2 ,price_time,Train_Table as Train_Table2
...
-- and TT_depart_time>%4
insert into Transfer_ar_tf (TF_tid_ar_tf,TF_arrive_tf_sid,TF_arrive_tf_price_yz,TF_arrive_tf_time,TF_tf_city_ar_tf,TF_seat_first_yz) select DISTINCT
...
insert into Transfer_ar (TF_tid_ar,TF_arrive_sid,TF_arrive_price_yz,TF_arrive_time,TF_city_ar,TF_seat_second_yz) select DISTINCT
TT_tid,TT_sid,TT_price_yz,TT_arrive_time ,TF_tf_city_de_tf,ES_left_yz
from Train_Table,Transfer_DE_tf,ID_Station_City,Empty_Seat
where  ISC_cname ='抚顺' and TT_sid=ISC_sid and TT_tid=TF_tid_de_tf and TT_price_yz!=0  and ES_date='2018-11-18' and TT_sid=ES_current_sid;
